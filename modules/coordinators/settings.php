							...
							<form>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-6 col-lg-3">
										<div class="form-group">
											<label>City</label>
											<input class="form-control" value="Accra" type="text">
										</div>
									</div>
									<div class="col-sm-6 col-md-6 col-lg-3">
										<div class="form-group">
											<label>Digital Address Code</label>
											<input class="form-control" value="BA-914-303" type="text">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input class="form-control" value="+233-978-7102" type="text">
										</div>
									</div>
								</div>
								<div class="row">
